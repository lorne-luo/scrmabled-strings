...
class TestCase(unittest.TestCase):
    ...
    def test_get_dict_maps(self):
        length_grouped_word_maps = get_dict_maps(
            {"axpaj", "apxaj", "pjxdn", "dnrbt", "abd"}
        )
    ...
    def test_check_scrambled_form(self):
        result = check_scrambled_form(
            "aapxj", get_byte_map("aapxj"), "aapxj", get_byte_map("aapxj")
        )  # equal
        self.assertTrue(result)

        result = check_scrambled_form(
            "axpaj", get_byte_map("axpaj"), "aapxj", get_byte_map("aapxj")
        )
        self.assertTrue(result)

        result = check_scrambled_form(
            "axpaj",
            get_byte_map("axpaj"),  # frequence diff
            "aaapxj",
            get_byte_map("aaapxj"),
        )
        ...
        result = check_scrambled_form(
            "aapxj",
            get_byte_map("aapxj"),  # end with diff
            "aapjx",
            get_byte_map("aapjx"),
        )
        self.assertFalse(result)
        ...
        result = check_scrambled_form(
            "abpxj",
            get_byte_map("abpxj"),  # diff char set
            "aapxj",
            get_byte_map("aapxj"),
        )
        self.assertFalse(result)
